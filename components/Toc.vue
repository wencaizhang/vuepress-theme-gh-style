<template>
  <!-- <Sticker class="vuepress-toc"
           v-bind="$attrs"
           v-if="visible"> -->
    <div class="toc-container" :class="sidebarClass">
      <div class="toc-toggle">
        <i class="toc-toggle-icon icon-arrow-down" role="button"></i> <span>toc</span>
      </div>
  ...
  export default {
    ...
    methods: {
      ...
      togglePined () {
        ...
        document.querySelector('body').style.marginLeft = '314px'
      },
      handleSetting () {
