<template>
  <div class="toc-container"
    ...
    :class="sidebarClass"
  >
    <div @mouseenter="onMouseenterToggle" class="toc-toggle d-flex flex-column flex-justify-center flex-items-center">
...
export default {
  ...
  methods: {
    ...
    togglePined() {
      ...
      this.visible = true;
      // document.querySelector("body").style.marginLeft = this.pined ? "314px" : 0;
    },
    handleSetting() {}
  },
};
